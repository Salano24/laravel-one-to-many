                ...
                <tr class="table-primary">
                    ...
                    <td>
                        <div class="actions d-sm-flex d-xxl-block flex-column p-3 min">
                            ...
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete Project-{{$type->slug}}">
                                <i class="fas fa-trash fa-md text-light"></i>
                            </button>


                            <div class="modal fade" id="delete Project-{{$type->slug}}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId-{{$type->slug}}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="modalTitleId-{{$type->slug}}">Delete Project</h5>
